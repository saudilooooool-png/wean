...
echo -e "  1. Fill in real API keys in ${PROJECT_ROOT}/.env"
echo -e "     • OPENAI_API_KEY"
echo -e "     • GOOGLE_MAPS_API_KEY"
echo -e "     • EVOLUTION_API_KEY"
echo -e "  2. Open Appwrite console and create a project with ID: ${APPWRITE_PROJECT_ID:-wean_project}"
echo -e "     Then generate an API key and update APPWRITE_API_KEY"
echo -e "  3. Restart the stack:  ${DC} restart"
echo -e "  4. Scan the WhatsApp QR code:"
echo -e "     ${EVO_URL}/instance/connect/${EVO_INSTANCE}"
echo -e "  5. Send your location on WhatsApp to start searching!"
echo ""
echo -e "  ${BOLD}Useful commands:${NC}"
echo -e "  • View all logs:          ${DC} logs -f"
echo -e "  • View LangChain logs:    ${DC} logs -f langchain-service"
echo -e "  • View n8n logs:          ${DC} logs -f n8n"
echo -e "  • Stop everything:        ${DC} down"
echo -e "  • Full reset:             $0 --reset"
echo ""
