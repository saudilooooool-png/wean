    ...
    <div className="space-y-6 relative">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex gap-2">
          <Button onClick={exportCSV} disabled={!data?.contacts.length} variant="outline" size="sm" className="gap-2">
            <Download size={15} />
            تصدير CSV
          </Button>
              ...
              {loading
                ...
                : data?.contacts.map((contact) => (
                    ...
                    >
                      ...
                      <td>
                        <Badge variant="secondary">{contact.searchCount}</Badge>
                      </td>
                      ...
                      <td>
                        {contact.status === 'opted_out' ? (
                          ...
                          <Badge variant="default" className="bg-green-100 text-green-700 hover:bg-green-100">نشط</Badge>
                        )}
                      </td>
                    </tr>
                  ))}
      ...
      {/* Side Panel */}
      <div className={`side-panel ${selected ? 'open' : ''}`} style={{ right: 0, left: 'auto', transform: selected ? 'translateX(0)' : 'translateX(100%)' }}>
        {selected && (
          <>
            {/* Panel Header */}
            ...
            <div className="p-5 space-y-6">
              ...
              <div className="text-center">
                ...
                <div className="mt-2">
                  {selected.status === 'opted_out' ? (
                    ...
                    <Badge className="bg-green-100 text-green-700">مستخدم نشط</Badge>
                  )}
                </div>
              </div>
                ...
                <div className="space-y-2 max-h-48 overflow-y-auto">
                  {(selected.searchHistory ?? []).map((rec, i) => (
                    <div key={i} className="flex items-center justify-between p-3 bg-slate-50 rounded-xl">
                      ...
                      <Badge variant="secondary" className="text-xs">{rec.results} نتائج</Badge>
                    </div>
                  ))}
              ...
              <div>
                ...
                />
                <Button onClick={sendDirectMessage} className="w-full bg-green-600 hover:bg-green-700 gap-2">
